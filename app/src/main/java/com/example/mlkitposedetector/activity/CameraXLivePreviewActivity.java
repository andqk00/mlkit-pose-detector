...
public class CameraXLivePreviewActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) selectedModel = savedInstanceState.getString(STATE_SELECTED_MODEL, POSE_DETECTION);
        cameraSelector = new CameraSelector.Builder().requireLensFacing(lensFacing).build();

        setContentView(R.layout.activity_vision_camerax_live_preview);
        previewView = findViewById(R.id.preview_view);
        if(previewView == null) Log.d(TAG, "PreviewView is null");
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        Toast.makeText(
                getApplicationContext(),
                "This device does not have lens facing: " + newLensFacing,
                Toast.LENGTH_SHORT
        ).show();
    }
